namespace UVP.ExternalIntegration.Business.Services
{
    ...
    public class StatusPollingService : IStatusPollingService
    {
        ...
        /// </summary>
        private async Task<bool> IsInvocationMatchAsync(string requestPayload, long doaCandidateId, long candidateId, string integrationType)
        {
            try
            {
        ...
        /// </summary>
        private async Task<bool> IsEarthMedPayloadMatchAsync(string requestPayload, long doaCandidateId, long candidateId)
        {
            try
            {
        ...
        /// </summary>
        private async Task<bool> IsAckInvocationMatchAsync(string requestPayload, string rvCaseId, long doaCandidateId, long candidateId, string integrationType)
        {
            try
            {
