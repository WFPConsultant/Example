namespace UVP.ExternalIntegration.Business.Model.Common
{
    ...
    {
        public AssignmentsItems[] Items { get; set; }
    }

    public class AssignmentsItems
    {
        ...
        public AssignmentEFFs AssignmentsEFF { get; set; }
        public AssignmentDFFs AssignmentsDFF { get; set; }
        public GradeSteps GradeSteps { get; set; }
